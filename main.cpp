...
int BinaryMatrixRankTest() {
    ...
    std::ifstream inputFile("/home/patryk/CLionProjects/untitled10/ciphersBinaryIsap.txt");
    if (!inputFile) {
        std::cerr << "Nie można otworzyć pliku wejściowego." << std::endl;
        return 1;
    }

    std::ofstream outputFile("/home/patryk/CLionProjects/untitled10/BinaryMatrixRankIsapTest.txt");
    if (!outputFile) {
...
int FrequencyMonobitsTest()
{
    ...
    std::ofstream outputFile("/home/patryk/CLionProjects/untitled10/frequencyMonobitsIsapTest.txt");
    if (!outputFile) {
        std::cerr << "Nie można otworzyć pliku wyjściowego." << std::endl;
        return 1;
    }
...
int RunsTest()
{
    ...
    std::ofstream outputFile("/home/patryk/CLionProjects/untitled10/RunsIsapTest.txt");
    if (!outputFile) {
        std::cerr << "Nie można otworzyć pliku wyjściowego." << std::endl;
        return 1;
    }
...
int FrequencyTestWithinABlock()
{
    ...
    std::ofstream outputFile("/home/patryk/CLionProjects/untitled10/FrequencyBlockIsapTest.txt");
    if (!outputFile) {
        std::cerr << "Nie można otworzyć pliku wyjściowego." << std::endl;
        return 1;
    }
...
int LongestRunOfOnesInABlock() {
    std::ifstream inputFile("/home/patryk/CLionProjects/untitled10/ciphersBinaryPhotonBeetle.txt");
    if (!inputFile) {
        std::cerr << "Nie można otworzyć pliku wejściowego." << std::endl;
        return 1;
    }

    std::ofstream outputFile("/home/patryk/CLionProjects/untitled10/LongestRunOfOnesInABlockPhotonBeetleTest.txt");
    if (!outputFile) {
        std::cerr << "Nie można otworzyć pliku wyjściowego." << std::endl;
        return 1;
    }
